...
import { Home, Calendar, Info, Phone, UserPlus, Clock, Award } from "lucide-react";
    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden pointer-events-none">
      <div className="flex justify-center pb-4 px-2">
        <motion.nav
          ...
          className="pointer-events-auto relative bg-background/80 backdrop-blur-md border border-border/50 rounded-2xl shadow-lg shadow-primary/5 overflow-hidden w-full max-w-sm"
        >
