          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="flex items-center gap-3 px-4 py-3 rounded-lg border border-neon-purple/50 shadow-[0_0_10px_hsl(var(--neon-purple)/0.3)] bg-card/50 text-sm font-medium text-neon-purple hover:bg-neon-purple/10 transition-colors"
              >
                <Download size={18} />
                <span>Download Agenda (100 KB)</span>
              </motion.a>
            </div>
