...
import { ArrowLeft, Phone, Users, FileText, CheckCircle, MessageCircle } from "lucide-react";
          ...
          <div className="relative px-8 py-16 md:py-24">
            ...
            >
              <div className="px-6 py-3 rounded-full bg-white/10 border border-white/20 inline-block">
                <span className="font-orbitron font-bold text-lg text-white">Event Completed</span>
              </div>
            </motion.div>
          </div>
        </motion.div>
            ...
            >
              <div className="bg-card rounded-2xl p-8 border border-border/50 text-center">
                ...
                <p className="text-muted-foreground mb-6">
                  This event has successfully concluded. Thank you for your interest!
                </p>
                <div className="mb-6 p-3 rounded-xl bg-neon-green/5 border border-neon-green/20">
                  <p className="text-neon-green font-orbitron font-bold">Ended on Jan 8, 2026</p>
                </div>
              </div>
