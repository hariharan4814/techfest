...
import { Lightbulb, Target, Award, BookOpen, Rocket, Users, Mail, Sparkles } from "lucide-react";
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="mb-20">
          <SectionTitle
            ...
            subtitle="Where Innovation Meets Celebration"
          />
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="mt-8 prose prose-lg prose-invert max-w-4xl mx-auto text-center"
          >
            <p className="text-lg text-muted-foreground leading-relaxed">
              TECHFEST 2026, organized by the PG & Research Department of Computer Science (Aided) , PSG College of Arts & Science, is a one-day technical fest featuring exciting technical and non-technical events. The fest provides a platform for students to showcase their skills, creativity, and innovation, compete for exciting prizes, and receive e-certificates and OD. Join us for a fun-filled and knowledge-driven experience.
            </p>
          </motion.div>
        </div>
        ...
        <div className="mb-20">
          <SectionTitle
            ...
            subtitle="Guidelines for a smooth and fair event"
          />
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="p-8 rounded-2xl bg-card border border-border/50 relative overflow-hidden">
              <div className="absolute top-0 left-0 w-1 h-full bg-gradient-to-b from-neon-cyan via-neon-magenta to-neon-purple" />
              <ul className="space-y-4">
                {[
                  "Discipline is strictly expected from all participants.",
                  "Reporting time for all participants is 9:30 AM",
                  "All participants must be punctual for all events.",
                  "Participants are requested to return to their respective classes once their tenure/event duration is over.",
                  "Only participants who attend the event will receive OD and an e-certificate.",
                  "Participants who fail to adhere to the rules will be disqualified on the spot.",
                  "The judge’s decision will be final for all events.",
                  "Please refer to the QR code and the official website for registration and further details."
                ].map((rule, index) => (
                  <motion.li
                    key={index}
                  ...
                  >
                    <span className="flex-shrink-0 mt-2 w-1.5 h-1.5 rounded-full bg-neon-cyan shadow-[0_0_10px_hsl(var(--neon-cyan))]" />
