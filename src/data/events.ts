...
export const events: Event[] = [
  {
    ...
    fullDescription: "DIGI BYTES is a thrilling 2-member team event that challenges your memory, technical skills, logical thinking, communication, and creativity across multiple fun-filled rounds.\n\nEvent Highlights:\n🔹 Round 1 – Memory Game: Memorize and recall technical terms\n🔹 Round 2 – Skill Round: Guess technical words using clues\n🔹 Round 3 – Coding Round: Fill missing code and crack logic\n🔹 Final Round (if applicable): Draw it right to win it all!\n\nEvent Structure:\nDIGI BYTES consists of three main rounds, and the event flow may vary depending on the number of participants:\nIf one batch is conducted, teams progress through Round 1 → Round 2 → Round 3, and the winners will be decided based on overall performance.\nIf two batches are conducted, top teams from each batch advance to a Winner Selection Round to decide 1st, 2nd & 3rd places and the winners will be decided based on their overall performances.\n\nWinners are selected based on overall performance.",
    rules: [
      "Team Size: 2 members",
      "Team changes not allowed",
      "Winners are selected based on overall performance",
      "Rounds: Memory Game, Skill Round, Coding Round",
    ],
    prizes: {
      first: "TBD",
      second: "TBD",
